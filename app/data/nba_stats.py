...
NBA_PLAYERS: dict[str, dict[str, Any]] = {
    ...
    "Victor Wembanyama": {"team": "SAS", "points": (24.5, 7.0), "rebounds": (10.5, 3.5), "assists": (3.8, 2.0), "threes_made": (2.2, 1.5), "steals": (1.2, 0.9), "blocks": (3.6, 1.6), "min": 33.0},
    "Devin Vassell":   {"team": "SAS", "points": (19.5, 5.5), "rebounds": (4.0, 2.0), "assists": (4.5, 2.0), "threes_made": (2.5, 1.4), "steals": (1.0, 0.8), "blocks": (0.5, 0.6), "min": 32.0},
    "Keldon Johnson":  {"team": "SAS", "points": (16.0, 5.5), "rebounds": (5.5, 2.5), "assists": (2.5, 1.5), "threes_made": (1.5, 1.1), "steals": (0.8, 0.7), "blocks": (0.4, 0.5), "min": 30.0},
    "Jeremy Sochan":   {"team": "SAS", "points": (12.5, 5.0), "rebounds": (6.5, 2.8), "assists": (3.0, 1.8), "threes_made": (0.8, 0.8), "steals": (1.0, 0.8), "blocks": (0.6, 0.6), "min": 28.0},
    "Tre Jones":       {"team": "SAS", "points": (10.5, 4.5), "rebounds": (3.0, 1.5), "assists": (6.0, 2.5), "threes_made": (0.5, 0.6), "steals": (1.0, 0.8), "blocks": (0.2, 0.4), "min": 28.0},
    "Stephon Castle":  {"team": "SAS", "points": (11.5, 5.0), "rebounds": (3.5, 1.8), "assists": (3.5, 2.0), "threes_made": (0.8, 0.8), "steals": (0.8, 0.7), "blocks": (0.5, 0.6), "min": 26.0},
    "Jaden McDaniels": {"team": "MIN", "points": (12.0, 5.0), "rebounds": (4.0, 2.0), "assists": (2.0, 1.2), "threes_made": (1.5, 1.1), "steals": (1.0, 0.8), "blocks": (0.8, 0.7), "min": 32.0},
    "Mike Conley":     {"team": "MIN", "points": (10.5, 4.5), "rebounds": (3.5, 1.5), "assists": (6.0, 2.5), "threes_made": (2.0, 1.3), "steals": (1.0, 0.8), "blocks": (0.2, 0.4), "min": 28.0},
    "Naz Reid":        {"team": "MIN", "points": (13.5, 5.0), "rebounds": (5.5, 2.5), "assists": (1.5, 1.0), "threes_made": (1.5, 1.1), "steals": (0.5, 0.6), "blocks": (1.0, 0.8), "min": 24.0},
    "Julius Randle":   {"team": "MIN", "points": (20.0, 6.0), "rebounds": (7.5, 3.0), "assists": (4.0, 2.0), "threes_made": (1.5, 1.1), "steals": (0.7, 0.6), "blocks": (0.4, 0.5), "min": 33.0},
    "Nickeil Alexander-Walker": {"team": "MIN", "points": (8.5, 4.0), "rebounds": (2.5, 1.5), "assists": (2.5, 1.5), "threes_made": (1.2, 1.0), "steals": (0.8, 0.7), "blocks": (0.3, 0.5), "min": 22.0},
